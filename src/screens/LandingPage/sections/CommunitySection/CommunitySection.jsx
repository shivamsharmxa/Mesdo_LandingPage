...
export const CommunitySection = () => {
  ...
  return (
    <motion.section
      className="flex flex-col items-start gap-2 pt-[100px] pb-[200px] px-[150px] relative self-stretch w-full flex-[0_0_auto] bg-white"
      initial="hidden"
      whileInView="visible"
      viewport={{ once: true, amount: 0.3 }}
      variants={containerVariants}
    >
      <div className="relative w-full max-w-[1140px] h-[698px]">
          ...
          <div className="absolute w-full max-w-[1140px] h-[599px] top-[99px] left-0">
            <div className="h-[599px]">
              <div className="relative w-[1166px] h-[617px] top-[-18px] left-[-26px]">
                ...
                >
                  {/* 
                    Dot positions calculation:
                    Card 1: left: 112px, top: 397px, dot center: +32px left, +32px top = (144, 429)
                    Card 2: left: 527px, top: 232px, dot center: +32px left, +32px top = (559, 264) 
                    Card 3: left: 868px, top: 39px, dot center: +32px left, +32px top = (900, 71)
                  */}
